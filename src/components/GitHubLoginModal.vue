        ...
        <div v-else-if="userCode" class="w-full flex flex-col items-center">
          ...
          <div class="w-full mb-6 text-center">
            ...
            <div class="flex items-center justify-center gap-2 bg-card-hover py-2 px-4 rounded-sm">
              <BaseButton variant="ghost" class="p-0! text-accent text-sm! break-all font-[inherit] hover:underline" @click="openGitHub" title="Open GitHub authorization page" aria-label="Open GitHub authorization page">{{ verificationUri }}</BaseButton>
