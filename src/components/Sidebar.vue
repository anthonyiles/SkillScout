...
<template>
  <nav class="bg-card/70 backdrop-blur-md w-[220px] h-screen flex flex-col p-4 border-r border-divider z-10">
    ...
    <div class="flex flex-col gap-2">
      ...
      <router-link to="/mcp" :class="navLinkClass('/mcp')">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="opacity-80"><rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><line x1="6" y1="6" x2="6.01" y2="6"/><line x1="6" y1="18" x2="6.01" y2="18"/></svg>
        MCP Servers
      </router-link>
    ...
    <div class="mt-auto">
      <BaseButton
        ...
        variant="default"
        size="lg"
        class="w-full rounded-md! text-[0.9rem]! font-medium hover:bg-page!"
      ...
      <BaseButton
        ...
        variant="custom"
        size="lg"
        class="group relative w-full rounded-md! text-[#4ade80] text-[0.9rem]! font-medium overflow-hidden bg-[rgba(74,222,128,0.1)] border-[rgba(74,222,128,0.2)] hover:border-[rgba(255,85,85,0.3)] hover:bg-transparent"
